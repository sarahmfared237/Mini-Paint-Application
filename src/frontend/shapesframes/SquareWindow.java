...
public class SquareWindow extends JDialog {
    ...
    public SquareWindow(JFrame parent, Engine engine) {
        super(parent, "Draw Square", ModalityType.DOCUMENT_MODAL);
    ...
    public void draw() {
        ...
        try {
            ...
            Rectangle square = new Rectangle(new Point(x,y), length, length);
            square.setColor(colorLabel.getBackground());
            square.setFillColor(fillColorLabel.getBackground());
